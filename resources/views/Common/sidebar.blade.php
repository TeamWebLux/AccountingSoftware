    ...
    <section class="sidebar position-relative">
        <div class="d-flex align-items-center logo-box justify-content-start d-md-block d-none">
            ...
            <a href="index.html" class="logo">
                <!-- logo-->
                <div class="logo-mini">
                    <span class="light-logo"><img src="{{ asset('storage/images/logo-letter.png') }}"
                            alt="logo"></span>
                </div>
                <div class="logo-lg">
        ...
        <div class="user-profile my-15 px-20 py-10 b-1 rounded10 mx-15">
            <div class="d-flex align-items-center justify-content-between">
                <div class="image d-flex align-items-center">
                    <img src="{{ asset('storage/images/avatar/avatar-13.png') }}" class="rounded-0 me-10"
                        alt="User Image">
                    <div>
            ...
            <div class="multinav-scroll" style="height: 97%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{ route('addrole') }}">
                                    <i class="icon-Add-user"><span class="path1"></span><span
                                            class="path2"></span></i>
                                    <span>Add Role</span>
                                </a></li>
                            <li> <a href="{{ route('showrole') }}">
                                    <i class="icon-Chart-pie"><span class="path1"></span><span
                                            class="path2"></span></i>
                                    <span>View Role</span>
                                </a>
